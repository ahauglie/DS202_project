...
ggplot(Trout, aes(x = Year)) +
  geom_line(Trout, aes( y = AVG), color = "blue") +
  geom_line(Trout, aes( y = SLG), color = "red") + 
  geom_line(Trour, aes( y = OPS), color = "purple") + 
  geom_line(Trout, aes( y = HRAB), color = "red") +
  ylab("Percentages") + 
  xlab("Year") + 
...
Rivals <- dat[(dat$Team == 'SF' ||dat$Team == 'SD'),]
?grepl
```
...
Distribution of BABIP with Buter Posey Highlighted
