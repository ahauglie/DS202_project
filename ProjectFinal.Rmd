...
ggplot(dat, aes(x = BABIP,)) + geom_histogram(color = "black", fill = "white") +
  ...
  annotate("Text", .38, 135, label = "Buster Posey's Average BABIP") + xlab("BABIP (Batting Average on Balls in Play") + ylab("Count") + ggtitle("Histogram of BABIP")
...
##
>>>>>>> 99c80b5f883da3e0788c536d9cb814e40a29cdcc
