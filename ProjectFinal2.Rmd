...
plot3d(dat$HR, dat2$AVG,dat2$MEANAVG,  xlab = "HR", ylab = "AVG", zlab = "MEANAVG") #Visualization for dat2
...
plot3d(dat$NPAB,dat$HRAB,dat$AVG, xlab = "NPAB", ylab = "HRAB", zlab = "AVG") #Does Avg # of pitches in an at bat correlate with batting Avg? Does it correlate with HRs?
