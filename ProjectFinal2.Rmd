...
plot3d(dat$RBIAB, dat$HR, dat$AVG, col = "blue" , size = 3, xlab = "RBIAB", ylab = "HR", zlab = "Average", aspect = TRUE)  #Explain what this shows, make new one with better visualization #change color to individual teams 
